	...
	return (
		<div className='py-20'>
			...
			<div className='flex justify-center'>
				<div className="grid lg:grid-cols-2 md:grid-cols-1 md:w-full">
					{menuItems.map((item) => (
						<div key={item.itemcategory} className="menu-cat">
							<h1 className="text-3xl text-center shadow-font uppercase sub-title burg p-2 m-2 title-font tracking-widest">
								{item.itemcategory}
							</h1>
